...
Studium przypadku Ukraina, afganistan, wenezuela.


Przejdźmy teraz do analizy korelacji między poziomem szczęścia a wybranymi czynnikami. Przypomnijmy po krótce na czym będą polegały użyte w raporcie metody.
\begin{itemize}
...
Wykres \ref{fig:korelacje} przedstawia wielkość korelacji między poziomem szczęścia czynnikami z naszego zbioru danych. 
