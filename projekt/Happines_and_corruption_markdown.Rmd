...
## Cel analizy
Sprawdzimy jak zmienia się globalny poziom _szczęścia_ na przestrzeni lat. Następnie znajdziemy miejsca, w których uśrednione wartości są najmniejsze lub największe. Poza tym, wyznaczymy i zobrazujemy korelację pomiędzy _szczęsciem_ a pozostałymi _statystykami_.
...
```{r, fig.cap="\\label{fig:świat}Poziom szczęścia na świecie", out.width="70%", fig.align = "center"}
u
```
