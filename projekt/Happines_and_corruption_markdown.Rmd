...
Niniejsze sprawozdanie zostało sporządzone w ramach laboratorium Pakietów Statystycznych, prowadzonych przez \href{https://dkucharc.github.io/academic/}{dr inż. Daniela Kucharczyka}, do wykładu \href{http://prac.im.pwr.edu.pl/~giniew/doku.php}{dr Andrzeja Giniewicza}. Naszym zadaniem jest analiza wybranych danych rzeczywistych, która posłuży do rozwiązania ustalonego problemu badawczego.
Do wykonania naszego celu wykorzystamy pakiet R wraz z jego dostępnymi bibliotekami, których krótki opis zawarliśmy w Tabeli \ref{tab:pakiety}).
\begin{center}
...
Packages <- data.frame(names, descriptions)
